    ...
    [pageView addSubview:tapToNextButton];
        ...
        if(page.titleIconView) {
            ...
            if ([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPad){
              //  rect1.origin.x = (self.scrollView.frame.size.width - rect1.size.width*2)/2;
...
//            if ([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPad){
//    
//                rect1.size.height=page.titleIconView.frame.size.height*2;
//                rect1.size.width=page.titleIconView.frame.size.width*2;
//            }
            ...
            if ([[UIDevice currentDevice] userInterfaceIdiom] ==UIUserInterfaceIdiomPhone)
            {
                ...
                if (screenBounds.size.height == 480) {
                    ...
                    rect1.size.height=page.titleIconView.frame.size.height/1.4;
                    rect1.size.width=page.titleIconView.frame.size.width/1;
